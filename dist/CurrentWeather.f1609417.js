...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"sections/CurrentWeather.js":[function(require,module,exports) {
...
function displayCurrentWeather() {
  ...
  var currentWeatherEndpoint = getCurrentWeatherEndpoint('București');
  fetch(currentWeatherEndpoint).then(function (response) {
    ...
    var name = data.name,
      ...
      wind = data.wind;
    var day = getDayOfTheWeek(dt);
    var hours = getHour(dt);
    ...
    var windSpeed = windToKmPerHour(Math.round(wind.speed));
    ...
    currentWeather.innerHTML = "\n      <img\n              src=\"images/orange.jpg\"\n              class=\"card-img img-fluid h-100\"\n              alt=\"...\"\n            />\n            <div class=\"card-img-overlay text-dark text-center pt-5\">\n              <div class=\"my-5\">\n                <h1 class=\"display-4 m-0 pt-3\">".concat(name, "</h1>\n                <p class=\"fs-5 mt-2\">").concat(day, ", ").concat(month, ", ").concat(hours, "</p>\n              </div>\n              <div\n                class=\"d-flex gap-3 justify-content-center align-items-center my-4\"\n              >\n                <p class=\"display-2\">").concat(temperature, "\xB0C</p>\n                <img\n                  src=\"images/sun.png\"\n                  class=\"img-fluid w-25 px-5 py-3\"\n                  alt=\"sun icon\"\n                />\n                <div class=\"d-flex flex-column gap-2 fw-semibold fs-5\">\n                  <div class=\"d-flex gap-2\">\n                    <p>Real Feel:</p>\n                    <p>").concat(realFeel, "\xB0C</p>\n                  </div>\n                  <div class=\"d-flex gap-2\">\n                    <p>Wind:</p>\n                    <p>").concat(windSpeed, " km/h</p>\n                  </div>\n                  <div class=\"d-flex gap-2\">\n                    <p>Humidity:</p>\n                    <p>").concat(humidity, "%</p>\n                  </div>\n                </div>\n              </div>\n              <p class=\"fs-5 fw-semibold\">").concat(weatherDescription, "</p>\n            </div>");
  });
}
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","sections/CurrentWeather.js"], null)
//# sourceMappingURL=/CurrentWeather.f1609417.js.map