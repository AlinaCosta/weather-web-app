function displayPopularCities(city) {
  ...
  fetch(bucharestEndpoint)
    ...
    .then((data) => {
      ...
      let galatiTemp = document.querySelector('.galati-temp');
      ...
      let galatiIcon = document.querySelector('.galati-icon');
      ...
      switch (city) {
        ...
        case 'Paris':
          ...
          break;
        case 'Galati':
          galatiTemp.innerHTML = `${temperature}°C`;
          galatiIcon.innerHTML = `<i class="bi ${weatherIcon}"></i
          >`;
          break;
        case 'Barcelona':
